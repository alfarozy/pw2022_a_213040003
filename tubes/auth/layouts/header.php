...
<head>
    ...
    <!-- icheck bootstrap -->
    <link rel="stylesheet" href="<?= assets("backoffice/plugins/icheck-bootstrap/icheck-bootstrap.min.css") ?>">
    <!-- Theme style -->
    <link rel="stylesheet" href="<?= assets("backoffice/dist/css/adminlte.min.css") ?>">
    <link rel="stylesheet" href="<?= assets("backoffice/dist/css/auth.css") ?>">
