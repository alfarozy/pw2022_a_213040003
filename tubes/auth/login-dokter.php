...
if (isset($_POST['login'])) {
    ...
    $doctor = Core::show($table, ['email' => $_POST['email']]);
    if ($doctor) {
        if (Core::check($_POST['password'], $doctor['password'])) {
...
<div class="login-box">
    <div class="login-logo">
        <a href="<?= base_url() ?>">Login dokter </a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
        <div class="card-body login-card-body">
            ...
            <form action="" method="post">
                ...
                <div class="text-center">
                    <a href="./register-dokter" class="text-success">Daftar sebagai dokter</a>
                </div>
            </form>
