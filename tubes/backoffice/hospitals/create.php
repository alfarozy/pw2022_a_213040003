                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="form-group col-lg-8">
                                        ...
                                        <textarea name="description" class="editor form-control" rows="2"></textarea>
                                    </div>
                                    <div class="form-group col-lg-4 mt-4">
                                        <div class="text-center mt-2">
                                            <img class="img-fluid rounded image-preview" src="<?= assets("img/doctors/default.png") ?>" alt="User profile picture">
                                        </div>
                                    </div>
                                </div>
                            </div>
