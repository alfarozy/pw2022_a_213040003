                                ...
                                <div class="row">
                                    <div class="col-md-4 my-4">
                                        <div class="text-center">
                                            <img class="profile-user-img img-fluid rounded image-preview" src="<?= assets($data['img']) ?>" alt="User profile picture">
                                        </div>
                                            ...
                                            <div class="form-group mt-5 ">
                                                <div class="input-group">
                                                    <div class="custom-file">
                                                        <input type="file" name="img" class="input-img custom-file-input" id="icon">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="type" id="type" class="form-control">
                                                <option value="umum" <?php if ($data['type']  == 'umum') {
                                                                            echo 'selected';
                                                                        }  ?>>Umum</option>
                                                <option value="medis" <?php if ($data['type']  == 'medis') {
                                                                            echo 'selected';
                                                                        }  ?>>Medis</option>
                                            </select>
                                        </div>
