...
if (isset($_POST['update'])) {
    ...
    $data = [
        ...
        'price_kons' => IDRToNum($_POST['price_kons']),
    ];
    if ($_POST['password']) {
    ...
    if ($_FILES['img']['error'] != 4) {
        if ($doctor != "img/doctors/default.png") {

            $pathFile =  Core::root_path() . "/assets" . "/" . $doctor['img'];
            unlink($pathFile);
        }
        $img = Core::uploadImage($_FILES['img'], "doctors");
        $data['img'] = $img['message'];
    }

    $update = Core::update('doctors', $data, ['id' => $doctor['id']]);

    if (!$update) {

        flash('error', "Terjadi kesalahan, silahkan periksa data yang diinputkan");
        redirect(base_url('page/dashboard-dokter/update-profil'));
    }
            ...
            <div class="row">
                <aside class="col-lg-3 col-xl-3">
                    ...
                    <nav class="nav flex-lg-column nav-pills mb-4">
                        <a class="nav-link " href="<?= base_url("page/dashboard-dokter") ?>">Dashboard</a>
                        <a class="nav-link" href="#">Buat artikel (coming soon)</a>
                        <a class="nav-link active" href="<?= base_url("page/dashboard-dokter/update-profil") ?>">Pengaturan akun</a>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8">
                                            <div class="row gx-3">
                                                <div class="col-12 mb-3">
                                                    ...
                                                    <input class="form-control" name="name" value="<?= $doctor['name'] ?>" required type="text">
                                                </div> <!-- col .// -->

                                                <div class="col-lg-6 col-md-6 mb-3">
                                                    <label class="form-label">Alamat email</label>
                                                    <input class="form-control" name="email" value="<?= $doctor['email'] ?>" required type="email">
                                                </div> <!-- col .// -->
                                                <div class="col-lg-6 col-md-6 mb-3">
                                                    <label class="form-label">No Telepon / Whatsapp</label>
                                                    <input class="form-control" name="whatsapp" value="<?= $doctor['whatsapp'] ?>" type="tel">
                                                </div> <!-- col .// -->
                                                <div class="col-lg-6 col-md-6 mb-3">
                                                    <label class="form-label">Pilih rumah sakit</label>
                                                    <select name="id_hospital" class="form-control select2bs4" required width="100%">
                                                ...
                                                <div class="col-lg-6 col-md-6 mb-3">
                                                    <label class="form-label">Tetapkan harga konsultasi</label>
                                                    <input class="form-control rupiah" type="text" name="price_kons" value="<?= currency_IDR($doctor['price_kons'] ?? 0) ?>">
                                                </div> <!-- col .// -->
                                                ...
                                                <div class="col-lg-12 mb-3">
                                                    <label class="form-label">Deskripsi tentang anda</label>
                                                    <textarea class="form-control editor" name="description" id="" cols="30" rows="10"><?= $doctor['description'] ?></textarea>
                                                </div> <!-- col .// -->
                                        ...
                                        <aside class="col-lg-4">
                                            <figure class="text-lg-center mt-3">
                                                <img class="img-lg mb-3 img-avatar image-preview" src="<?= assets($doctor['img']) ?>" alt="User Photo">
                                                <figcaption>
